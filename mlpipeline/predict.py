...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_standard', required=False, type=lambda x: (str(x).lower()=='true'), 
                        help='using standard for normalization or not')
    ...
    parser.add_argument('--scaler', required=False, type=str, help='scaler generated by train data')
